...
if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('NAMA PRODUK BELUM DISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
     ShowMessage('KATEGORI BELUM DIISI DENGAN BENAR');
    end else
    if e_4.text=''then
    begin
    ...
    if e_5.text=''then
    begin
    ShowMessage(' STOK BELUM DIISI DENGAN BENAR');
    end else
 ...
 zqry1.SQL.Clear;
 zqry1.SQL.Add('insert into produk values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update produk set id= "'+e_1.Text+'",nama_produk="'+e_2.Text+'",kategori="'+e_3.Text+'",harga_satuan="'+e_4.Text+'",stok="'+e_5.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from produk where id="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from produk');
zqry1.Open;
