...
if e_1.Text='' then
  begin
    ...
    if e_4.text=''then
    begin
    ShowMessage(' NO TELPON BELUM SESUAI');
    end else
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into pelanggan values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update pelanggan set id= "'+e_1.Text+'",nama_pelanggan="'+e_2.Text+'",alamat="'+e_3.Text+'",no_telepon="'+e_4.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
