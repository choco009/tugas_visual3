...
if e_1.Text='' then
  begin
    ...
    if e_4.text=''then
    begin
    ShowMessage('GAJI BULANAN BELUM SESUAI');
    end else
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into karyawan values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update karyawan set id= "'+e_1.Text+'",nama_karyawan="'+e_2.Text+'",jabatan="'+e_3.Text+'",gaji_bulanan="'+e_4.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
