...
if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('TANGGAL TRANSAKSI BELUM DISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into transaksi values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'")');
 zqry1.ExecSQL ;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update supplier set id= "'+e_1.Text+'",tanggal_transaksi="'+e_2.Text+'",id_pelanggan="'+e_3.Text+'",total_harga="'+e_4.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
